...
function MakeNotifi(Configs)
  local Title = Configs.Title or "Bear Hub"
...
function MakeWindow(Configs)
  local title = Configs.Hub.Title or "Bear Hub"
  local Anim_Title = Configs.Hub.Animation or "by : Quang Huy"
